...
# Configuration Script – Emaux - Rev. A

This **Configuration** script is designed for the **Emaux** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Emaux Rev. A

Este script de **Configuration** está diseñado para el modelo **Emaux** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
